# XQ Express Tracking API For Java
XQ Express Tracking API and webhook make it easy to integrate XQ Express Tracking function into your own project. Support APIs Client Libraries for java

### API key

In order to use this API, you need to generate a XQ Express Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use XQ Express Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [XQ Express Tracking API](https://www.trackingmore.com/xqwl-tracking.html)  to:

   *   Get XQ Express realtime tracking info of muti-carriers in one integration
   *   Provide XQ Express shipment tracking experience like Amazon
   *   Push XQ Express notifications of package update with webhook
   *   Verify XQ Express delivery exception before it is too late
